...
set(MSG_I_FLAGS "-Ipwm:/home/shoh/cubic_code/src/pwm/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/shoh/cubic_code/src/pwm/msg/pwm.msg" NAME_WE)
add_custom_target(_pwm_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "pwm" "/home/shoh/cubic_code/src/pwm/msg/pwm.msg" ""
)
...
_generate_msg_cpp(pwm
  "/home/shoh/cubic_code/src/pwm/msg/pwm.msg"
  "${MSG_I_FLAGS}"
  ""
...
### Generating Messages
_generate_msg_eus(pwm
  "/home/shoh/cubic_code/src/pwm/msg/pwm.msg"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/pwm
)

### Generating Services

### Generating Module File
_generate_module_eus(pwm
  ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/pwm
  "${ALL_GEN_OUTPUT_FILES_eus}"
)

add_custom_target(pwm_generate_messages_eus
  DEPENDS ${ALL_GEN_OUTPUT_FILES_eus}
)
add_dependencies(pwm_generate_messages pwm_generate_messages_eus)

# add dependencies to all check dependencies targets
get_filename_component(_filename "/home/shoh/cubic_code/src/pwm/msg/pwm.msg" NAME_WE)
add_dependencies(pwm_generate_messages_eus _pwm_generate_messages_check_deps_${_filename})

# target for backward compatibility
add_custom_target(pwm_geneus)
add_dependencies(pwm_geneus pwm_generate_messages_eus)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS pwm_generate_messages_eus)
...
### Generating Messages
_generate_msg_nodejs(pwm
  "/home/shoh/cubic_code/src/pwm/msg/pwm.msg"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/pwm
)

### Generating Services

### Generating Module File
_generate_module_nodejs(pwm
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/pwm
  "${ALL_GEN_OUTPUT_FILES_nodejs}"
)

add_custom_target(pwm_generate_messages_nodejs
  DEPENDS ${ALL_GEN_OUTPUT_FILES_nodejs}
)
add_dependencies(pwm_generate_messages pwm_generate_messages_nodejs)

# add dependencies to all check dependencies targets
get_filename_component(_filename "/home/shoh/cubic_code/src/pwm/msg/pwm.msg" NAME_WE)
add_dependencies(pwm_generate_messages_nodejs _pwm_generate_messages_check_deps_${_filename})

# target for backward compatibility
add_custom_target(pwm_gennodejs)
add_dependencies(pwm_gennodejs pwm_generate_messages_nodejs)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS pwm_generate_messages_nodejs)
...
if(geneus_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/pwm)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/pwm
    DESTINATION ${geneus_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_eus)
  add_dependencies(pwm_generate_messages_eus std_msgs_generate_messages_eus)
endif()
...
if(gennodejs_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/pwm)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/pwm
    DESTINATION ${gennodejs_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_nodejs)
  add_dependencies(pwm_generate_messages_nodejs std_msgs_generate_messages_nodejs)
endif()

if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/pwm)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/pwm\")")
  # install generated code
  install(
